...
I'm a software developer working on libraries for the web and the lead developer of the [RxPlayer](https://github.com/canalplus/rx-player) project at Canal+, an adaptive streaming engine built for media streaming companies.
...
I also created multiple other open-source projects, including:
  ...
  - 📹 [AISOBMFFWVDFBUTFAII](https://github.com/peaBerberian/AISOBMFFWVDFBUTFAII): An online inspector for MP4 files ([demo page](https://peaberberian.github.io/AISOBMFFWVDFBUTFAII/)).<br>
    Written initially as a personal project to improve my understanding of the format, it is now actually used at my work by different teams to easily inspect those files. It relies on another library of mine doing the parsing, [`isobmff-inspector`](https://github.com/peaBerberian/isobmff-inspector).
